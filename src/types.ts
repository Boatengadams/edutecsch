...
export interface ElectionConfig {
  ...
  applicationStart: firebase.firestore.Timestamp | null;
  applicationEnd: firebase.firestore.Timestamp | null;
  campaigningStart: firebase.firestore.Timestamp | null;
  votingStart: firebase.firestore.Timestamp | null;
  votingEnd: firebase.firestore.Timestamp | null;
