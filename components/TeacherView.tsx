            ...
            <div className="flex-grow overflow-y-auto p-4 space-y-4">
                {messages.length === 0 ? (
                    ...
                    <div key={msg.id} className="flex flex-col items-start">
                        ...
                        <div className="p-3 bg-slate-700 rounded-lg max-w-xs text-sm break-words">
                           {msg.text}
                        </div>
                    </div>
                ))}
...
const CreateGroupModal: React.FC<{
    ...
    useEffect(() => {
        const subs = subjectsByClass[selectedClass] || [];
                                    ...
                                    <div className="flex justify-between items-start">
                                     ...
                                     {isGrading === submission.id ? (
                                        ...
                                        <>
                                            ...
                                            {submission.attachmentURL && <a href={submission.attachmentURL} target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline mt-2 inline-block">View Attachment</a>}
